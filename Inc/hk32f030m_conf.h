...
extern "C"
{
     ...
     * your application. This value is used by the RCC  module to compute the
     * system frequency (when HSE is used as system clock source, directly or
     * through the PLL).
     */

#define EXTCLK_VALUE \
    ((uint32_t)32000000) /*!< Value of the Internal oscillator in Hz*/

    /**
     * @brief Internal High Speed oscillator (HSI) value.
     *        This value is used by the RCC  module to compute the system
     * frequency (when HSI is used as system clock source, directly or through
     * the PLL).
     */
